...
namespace AlphaSales.Areas.CoachArea.Controllers;

[Area("CoachArea")]
[Authorize(Roles = SD.Role_Coach)]
public class CoachController : Controller
{
    ...
    public CoachController(IWebHostEnvironment environment, ApplicationDbContext context, IUnitOfWork unitOfWork
