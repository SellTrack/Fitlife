...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        "ajax": { url: '/EmployeeArea/QCEmployee/getall' }, // Doğru controller ve action yolu
        "columns": [
            ...
            { data: 'applicationUser2.name' },
            {
                ...
                "render": function (data, type, row) {
                    if (row.client_status === 1 || row.client_status === 2) {
                        ...
                        <a href="/EmployeeArea/QCEmployee/Upsert?id=${data}" class="item" data-toggle="tooltip" data-placement="top" title="Satışı Düzenle"><i class="zmdi zmdi-edit"></i></a>
                        ...
                        <a href="/EmployeeArea/QCEmployee/QCEdit?id=${data}" class="item" data-toggle="tooltip" data-placement="top" title="QC yap"><i class="zmdi zmdi-phone"></i></a>
                    </div>`;
                    } else {
                        return `<div class="table-data-feature">
                        <a href="/EmployeeArea/QCEmployee/Upsert?id=${data}" class="item" data-toggle="tooltip" data-placement="top" title="Satışı Düzenle"><i class="zmdi zmdi-edit"></i></a>
