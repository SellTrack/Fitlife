...
function loadDataTable() {
    dataTable = $('#tblData').DataTable({
        "ajax": { url: '/EmployeeArea/ExecutiveClient/getall' }, // Doğru controller ve action yolu
        "columns": [
            ...
            { data: 'applicationUser2.name' },
            {
                ...
                "render": function (data, type, row) {
                    if (row.client_status === 1 || row.client_status === 2) {
                        ...
                        <a href="/EmployeeArea/ExecutiveClient/Upsert?id=${data}" class="item" data-toggle="tooltip" data-placement="top" title="Satışı Düzenle"><i class="zmdi zmdi-edit"></i></a>
                        <a href="/EmployeeArea/ExecutiveClient/DownloadFile?clientID=${data}" class="item" data-toggle="tooltip" data-placement="top" title="Pdf indir"><i class="zmdi zmdi-download"></i></a>
                    </div>`;
                    } else {
                        return `<div class="table-data-feature">
                        <a href="/EmployeeArea/ExecutiveClient/Upsert?id=${data}" class="item" data-toggle="tooltip" data-placement="top" title="Satışı Düzenle"><i class="zmdi zmdi-edit"></i></a>
                        <a href="/EmployeeArea/ExecutiveClient/DownloadFile?clientID=${data}" class="item" data-toggle="tooltip" data-placement="top" title="Pdf indir"><i class="zmdi zmdi-download"></i></a>
                        <a onClick=Delete('/EmployeeArea/ExecutiveClient/Delete/${data}') class="item" data-toggle="tooltip" data-placement="top" title="Satışı sil"><i class="zmdi zmdi-delete"></i></a>
                    </div>`;
                    }
                }
            }
            ...
            { data: 'applicationUser2.name' },
            {
                ...
                "render": function (data, type, row) {
                    if (row.client_status === 1 || row.client_status === 2) {
                        ...
                        return `<div class="table-data-feature">
                        <a href="/EmployeeArea/ExecutiveClient/Upsert?id=${data}" class="item" data-toggle="tooltip" data-placement="top" title="Satışı Düzenle"><i class="zmdi zmdi-edit"></i></a>
                        <a href="/ClientArea/client/DownloadFile?clientID=${data}" class="item" data-toggle="tooltip" data-placement="top" title="Pdf indir"><i class="zmdi zmdi-download"></i></a>
                    </div>`;
                    }
                }
            }
